...
class SandboxFusionTool(BaseTool):
    ...
    def __init__(self, config: dict, tool_schema: OpenAIFunctionToolSchema):
        ...
        self.sandbox_fusion_url = os.environ.get("SANDBOX_FUSION_URL") or config.get("sandbox_fusion_url", "")
        self.memory_limit_mb = config.get("memory_limit_mb", 1024)
        if self.sandbox_fusion_url == "":
            raise ValueError("sandbox_fusion_url is not set (set SANDBOX_FUSION_URL or yaml config)")
